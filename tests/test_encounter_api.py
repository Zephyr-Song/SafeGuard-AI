...
class EncounterApiTest(unittest.TestCase):
    ...
    def test_workspace_and_v1_routes_are_available(self):
        ...
        self.assertIn(
            b'<textarea id="projectTitle" class="project-scroll-field"',
            workspace.data,
        )
        self.assertIn(
            b'<textarea id="projectReviewContext" class="project-scroll-field"',
            workspace.data,
        )
        self.assertIn(
            b'<textarea id="projectContext" class="project-scroll-field"',
            workspace.data,
        )
        self.assertIn(
            b'<textarea id="targetPeople" class="project-scroll-field"',
            workspace.data,
        )

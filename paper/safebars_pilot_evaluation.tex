...
\begin{table}[t]
  ...
  \label{tab:pilot}
  \begin{tabular}{p{1.2cm}p{1.8cm}p{1.3cm}p{2.0cm}p{0.8cm}}
    \toprule
...
into citable precedent, e.g.\ \textit{exam\_\allowbreak proctoring\_\allowbreak surveillance\_\allowbreak 2020}:
...
monitoring.''}; \textit{obermeyer\_\allowbreak health\_\allowbreak bias\_\allowbreak 2019}: \textit{``A proxy
...
\textit{uk\_\allowbreak a\_\allowbreak levels\_\allowbreak algorithm\_\allowbreak 2020}: \textit{``When an algorithm
...
al. A verbatim replay of R1's mirror conversation shows the AI surfacing
each tension step by step from the researcher's own plan. It \textbf{does not
yet support} a claim that the mirror \emph{corrects}
